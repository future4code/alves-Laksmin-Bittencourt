...
const funcionarios: Funcionario[] = [
	...
	{ nome: "Natalia" ,salario: 4700, setor: SETORES.MARKETING, presencial: true},
	{ nome: "Paola" ,salario: 3500, setor: SETORES.VENDAS, presencial: true }
]

function marketingPresencial(lista: Funcionario[]): Array <Funcionario> {
    const listaFuncionarios: Funcionario[] =  lista.filter((funcionario) => {
        return funcionario.setor === SETORES.MARKETING && funcionario.presencial === true;
    })
    return listaFuncionarios
}
console.log(marketingPresencial(funcionarios))
