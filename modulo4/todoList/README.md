...
CREATE TABLE todoist_tasks (
    ...
    FOREIGN KEY (author_id) REFERENCES todoist_users(id)
    );
    
CREATE TABLE todoist_assignees (
	task_id VARCHAR(64),
	assignee_id VARCHAR(64),
    PRIMARY KEY (task_id, assignee_id),
    FOREIGN KEY (task_id) REFERENCES todoist_tasks(id),
    FOREIGN KEY (assignee_id) REFERENCES todoist_users(id)
    );