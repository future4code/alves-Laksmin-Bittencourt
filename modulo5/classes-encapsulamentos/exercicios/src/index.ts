// Ex1:
//A)
/*'Construtor' é método obrigatório no paradigma POO que define as regras de inicialização
...
console.log(firstUser);
    ...
    R: Ao executar a chamada, foi impresso uma única vez a mensagem no console.log. */
